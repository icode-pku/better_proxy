...
# sudo docker build --no-cache  -t better_proxy:v1.0.0 -f dockerfile/image.dockerfile  .  # 基于dockerfile构建镜像
# sudo docker run -dt --name our_proxy -p 10809:10809  -v /home/niupeiyu/config:/host_xray_config/  better_proxy:v1.0.0   # 构建容器
